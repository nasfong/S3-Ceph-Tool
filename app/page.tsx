          ...
          {showKeyForm ? (
            ...
            <div className="w-full max-w-xl rounded-2xl border border-hairline bg-surface/90 p-8 shadow-[0_24px_80px_-32px_rgba(99,102,241,0.55)] sm:p-10">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-hairline bg-surface-3 px-4 py-2.5 text-sm font-medium text-primary transition-all duration-150 hover:border-indigo-400/60 hover:bg-surface-3"
              >
                Use S3 access keys
              </button>
            </div>
