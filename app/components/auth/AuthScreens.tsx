...
export const NoS3Account = ({ onLogout }: { onLogout: () => void }) => (
  <div className="flex items-center justify-center min-h-screen bg-app">
    <div className="text-center space-y-3">
      ...
      <p className="text-primary text-lg font-semibold">No S3 account found</p>
...
export const AuthError = ({ onLogout }: { onLogout: () => void }) => (
  <div className="flex items-center justify-center min-h-screen bg-app">
    <div className="text-center space-y-3">
      ...
      <p className="text-primary text-lg font-semibold">Authentication failed</p>
      <p className="text-muted text-sm">
      ...
      <div className="flex gap-3 justify-center">
        <button
          ...
          className="mt-4 px-4 py-2 text-sm font-medium text-primary bg-gray-600 hover:bg-gray-700 rounded-lg transition-colors"
        >
          Refresh
        </button>
        <LogoutButton onLogout={onLogout} />
